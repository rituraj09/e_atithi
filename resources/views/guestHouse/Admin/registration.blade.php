			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper p-5">
                    ...
                    <form class="forms-sample" action="{{ route('guest-house-admin-registration')}}" method="post">
                        @csrf
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        <label for="role" class="form-label col-md-4 m-auto">Role</label>
                        <div class="col-md-8">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                          <input type="password" class="form-control" id="confirmPassword" name="confirmPassword" autocomplete="current-password" placeholder="Confirm password" required>
                        </div>
                      </div>
